...
- (void) loadView
{
    self.view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, [UIScreen mainScreen].bounds.size.height - 64 -49)];
...
//    if(showsZBarControls || self.parentViewController.modalViewController == self)
//    {
